...
validated_main_vi, errs, warns = validate_numeric_table(ev_main, "主开关管导通表", [TEMP_COL, CURRENT_COL, "V_drop (V)"])
...
validated_diode_vi, errs, warns = validate_numeric_table(ev_diode, "二极管导通表", [TEMP_COL, CURRENT_COL, "Vf (V)"])
